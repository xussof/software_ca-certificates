# software_ca-certificates
=========

This role will install ca-certificates software
...
--------------------
    ...
    ---
    - src: git@github.com:xussof/software_ca-certificates
      scm: git
      version: master
      name: software_ca-certificates
